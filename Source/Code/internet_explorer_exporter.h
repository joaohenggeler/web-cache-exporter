#ifndef INTERNET_EXPLORER_EXPORTER_H
#define INTERNET_EXPLORER_EXPORTER_H
...
// If we want to use them, we have to explicitly wrap the code with #ifndef WCE_9X [...] #endif.
#ifndef WCE_9X
